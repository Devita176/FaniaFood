...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 23, 2026 at 04:11 PM
...
CREATE TABLE `pesanan` (
  ...
  `metode_bayar` enum('transfer_bank','qris','cod') NOT NULL,
...
CREATE TABLE `users` (
  ...
  `role` enum('pelanggan','admin','kepala') DEFAULT 'pelanggan',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'Admin Fania', 'admin@fania.com', '0192023a7bbd73250516f069df18b500', '081234567890', 'Yogyakarta', 'admin', '2026-02-27 06:02:39'),
(2, 'Kepala Fania', 'kepala@fania.com', '836b1f7f9b7f9bf98f1f645302defc59', '081234567891', 'Yogyakarta', 'kepala', '2026-02-27 06:02:39'),
(3, 'Budi Pelanggan', 'budi@gmail.com', '9c5fa085ce256c7c598f6710584ab25d', '081234567892', 'Sleman', 'pelanggan', '2026-02-27 06:02:39');
